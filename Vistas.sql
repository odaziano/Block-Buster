...
SELECT socio, docsocio, MatInsc
FROM vista_club
WHERE MatInsc = 'n' OR MatInsc IS NULL;
...
SELECT DISTINCT socio, dia, deporte
FROM vista_club
...
SELECT c.deporte, c.dia, COUNT(i.documentosocio) AS Insc_x_Curso
